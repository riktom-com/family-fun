...
function switchView(mode) {
  ...
  if (mode === 'map') {
    ...
    // Force synchronous layout — reading offsetHeight makes the browser
    // compute layout NOW, so the container has real dimensions before
    // we initialize or measure Leaflet.
